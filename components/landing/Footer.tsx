        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-lg">Pixel Canvas</span>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Collaborative pixel art for charitable causes. Every pixel makes a difference.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              2024 Pixel Canvas for Change. Made with purpose.
            </p>
            ...
            <div className="flex items-center gap-2 text-sm text-gray-400">
              ...
              <span className="font-semibold text-white">Every.org</span>
            </div>
          </div>
        </div>
      </div>
